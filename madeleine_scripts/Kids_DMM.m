...
for i=1:nchains
    ...
    S.delta = ones(46,1)*0.1; % Initial drift rate
...
[samples, stats ] = matjags(datastruct,fullfile('/oak/stanford/groups/menon/projects/mcsnyder/2018_RLDDM_JAGS/madeleine_scripts/kids_wiener4.txt'),init0,'doparallel',doparallel,'nchains',nchains,'nburnin', nburnin,'nsamples', nsamples,'thin', 1,'dic', 1,'monitorparams', {'alpha','tau','beta','delta','px'},'savejagsoutput' , 1 ,'verbosity' , 1 ,'cleanup' , 0  );
toc
